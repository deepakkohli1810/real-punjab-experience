  ...
  return (
    <div className="relative text-center" ref={dropdownRef}>
      ...
      <button
        ...
        className={`text-gray-700 lg:px-10 lg:py-1 text-center xl:text-xl md:text-lg rounded-full transition-all duration-300 ease-in-out flex items-center gap-2
