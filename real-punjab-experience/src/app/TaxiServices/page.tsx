      ...
      <div className="relative  text-white py-20 md:py-28">
        ...
        <div className="relative z-20 max-w-7xl font-sans mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl font-serif text-primary/80 max-w-3xl mx-auto leading-relaxed">
            Travel in comfort, style, and safety. Choose
            from our well-maintained fleet of vehicles,
            driven by experienced, professional chauffeurs
            for local sightseeing or outstation trips.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 font-serif lg:px-8 py-16 -mt-10 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {vehicles.map((vehicle) => (
            <div
              key={vehicle.id}
              className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 bg-gray-50 relative group flex flex-col"
            >
              {/* Badges */}
      ...
      <div className="bg-white py-16 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-sans font-bold tracking-wide text-gray-900 mb-4">
              Why Choose Our Taxi Services?
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto tracking-wide">
              We prioritize your safety, comfort, and peace
              of mind throughout your journey across Punjab.
            </p>
          </div>
      ...
      <div className="xl:px-40 lg:px-20 md:px-10 px-4">
        <div className="bg-[#1c2b60] rounded-4xl mt-2 py-16">
          <div className="max-w-4xl mx-auto px-4 text-center text-white">
            <h2 className="text-3xl font-sans tracking-wide font-bold mb-4">
              Ready to Plan Your Journey?
            </h2>
            <p className="text-[#f4ebd7]/80 font-serif mb-8 text-lg">
              Whether it's a quick airport transfer or a
              week-long tour of Punjab, we have the perfect
              vehicle for you.
            </p>
