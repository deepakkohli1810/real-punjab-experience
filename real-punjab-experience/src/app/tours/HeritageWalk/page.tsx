...
export default function HeritageWalk() {
  const tourData = {
    ...
    description:
      "Step back in time on a guided walking tour through the narrow, 400-year-old lanes of Old Amritsar. Starting from the historic Town Hall and ending at the Golden Temple, discover the city's rich architecture, bustling traditional markets, and hidden stories.",

    // Meeting point for the walking tour
    meetingPoint:
      "Town Hall (In front of Brothers Dhaba), Amritsar",
    ...
    schedule: [
      {
        ...
        description:
          "Meet your guide at the historic Town Hall, built in 1870, which once housed the British secretary's office during the Raj.",
        bullets: [
      ...
      },
      {
        ...
        description:
          "Walk down the oldest street in Amritsar, connecting Town Hall to the Golden Temple, and explore the ancient fort.",
        bullets: [
      ...
      },
      {
        ...
        description:
          "Dive deep into the by-lanes to see the traditional residential and community structures of old Amritsar.",
        bullets: [
      ...
      },
      {
        ...
        description:
          "Experience the vibrant trade centers of the old city and watch artisans at work.",
        bullets: [
      ...
      },
      {
        ...
        description:
          "Pass through the famous food square and conclude your walk at the entrance of the Golden Temple.",
        bullets: [
    ...
    images: [
      "/HeritageImages/HeritageImage.jpeg",  
