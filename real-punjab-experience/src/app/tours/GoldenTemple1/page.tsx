...
export default function GoldenTemple() {
  const tourData = {
    ...
    description:
      "Experience the spiritual heart of Sikhism with our guided day tour to the magnificent Golden Temple. Witness the mesmerizing ceremonies, enjoy a traditional meal at the community kitchen (Langar), and explore the historic Jallianwala Bagh.",
    ...
    schedule: [
      {
        ...
        description:
          "Meet your guide at the hotel lobby or Amritsar Railway Station and drive to the Golden Temple.",
        bullets: [],
      },
      {
        activity: "Golden Temple Visit",
        description:
          "A guided walk through the entire Golden Temple complex — one of the most sacred sites in the world.",
        bullets: [
      ...
      },
      {
        ...
        description:
          "Enjoy a traditional vegetarian meal at the Guru Ka Langar, the community kitchen that serves thousands daily.",
        bullets: [
      ...
      },
      {
        ...
        description:
          "Walk through the memorial garden where the 1919 massacre took place — a sobering and essential part of India's independence story.",
        bullets: [
      ...
      },
      {
        ...
        description:
          "Return to your hotel or the railway station, concluding your memorable day in Amritsar.",
        bullets: [],
      },
    ],
    ...
    images: [
      ...
      "/Images/GuestWithRishi.jpeg",
      "/Images/GuestWithRishi2.jpeg",
      "/Images/langar-golden-temple.jpeg",
      "/Images/AjayWithGuests.jpeg",
      "/Images/AjayWithGuests2.jpeg",
